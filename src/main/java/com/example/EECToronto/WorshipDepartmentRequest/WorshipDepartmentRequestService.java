...
@Service
public class WorshipDepartmentRequestService {
    private final WorshipDepartmentRequestRepository requestRepository;
    private final MembersRepository membersRepository;
    private final TeamsRepository teamsRepository;
    private final TeamMembersRepository teamMembersRepository;

    @Autowired
    public WorshipDepartmentRequestService(
            WorshipDepartmentRequestRepository requestRepository,
    ...
    public WorshipDepartmentRequest createRequest(WorshipDepartmentRequest request) {
        // Validation
        ...
        Optional<WorshipDepartmentRequest> existingByPhone = requestRepository.findByPhoneAndContacted(phone, false);
        Optional<WorshipDepartmentRequest> existingByEmail = requestRepository.findByEmailAndContacted(email, false);
    ...
    public List<WorshipDepartmentRequest> getAllRequests() {
        return requestRepository.findAllByOrderByRequestDateDesc();
    }

    public List<WorshipDepartmentRequest> getUncontactedRequests() {
        return requestRepository.findByContacted(false);
    }

    public WorshipDepartmentRequest markAsContacted(Long id) {
        WorshipDepartmentRequest request = requestRepository.findById(id)
    ...
    public String addToMembersList(Long requestId) {
        // 1. Get request
        WorshipDepartmentRequest request = requestRepository.findById(requestId)
                .orElseThrow(() -> new RuntimeException("Request not found"));
        ...
        // 4. Find Worship Department team (should already exist)
        Teams worshipTeam = teamsRepository.findByTeam_nameIgnoreCase("Worship Department")
                .or(() -> teamsRepository.findByTeam_nameIgnoreCase("Worship"))
                .orElseThrow(() -> new RuntimeException("Worship Department team not found. Please create it first."));
        ...
        return "Member added to Worship Department successfully";
    }
}
